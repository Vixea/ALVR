...
void CEncoder::Run() {
    ...
    sch_params.sched_priority = 1; //maximum priority without requiring root privileges(while still having policy doing something)
		if(pthread_setschedparam(todo(), SCHED_RR, &sch_params)) {
